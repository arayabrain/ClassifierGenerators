...
for i in range(40000):
	err += trainingStep(net, 20, min_difficulty = difficulty_level, max_difficulty = difficulty_level, feature_variation = False, class_variation = False)
	err_count += 1
	...
	if err_count >= 50:
		...
		f = open("training_curves/training2-N20.txt","a")
		...
		torch.save(net.state_dict(),open("models/classifier-generator-2-4-N20.pth","wb"))
