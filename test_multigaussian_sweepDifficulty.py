...
# Sweep Sigma
f = open("results/Sigma-128-16-100.txt","wb")
f.write("Sigma;LSVC;;SVC;;RF;;XGB;;KNN;;$CG_{32,16}^{100,0.2}$;;$CG_{128,16}^{100,0.2}$;\n")
f.close()

for sigma in np.arange(0.05,1.5,0.05):
	results = compareMethodsOnProblem(methods, 16, 128, sigma, N=100, samples=20)
	f = open("results/Sigma-128-16-100.txt","a")
	f.write("%.3g" % (sigma))
