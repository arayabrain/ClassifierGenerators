...
for i in range(100000):	
	...
	if i%10000 == 5000:
		torch.save(net.state_dict(),open("ckpt/classifier-generator-128-16-ckpt%d.pth" % i,"wb"))
	...
	if err_count >= 50:
		...
		f = open("training_curves/training128-16.txt","a")
		...
		torch.save(net.state_dict(),open("models/classifier-generator-128-16.pth","wb"))
