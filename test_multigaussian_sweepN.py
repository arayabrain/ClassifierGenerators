...
# Sweep N
f = open("results/N-128-16-100.txt","wb")
f.write("N;LSVC;;SVC;;RF;;XGB;;KNN(N=5);;$CG_{32,16}^{100,0.2}$;;$CG_{128,16}^{100,0.2}$;\n")
f.close()

for N in range(20, 410, 10):
	results = compareMethodsOnProblem(methods, 16, 128, 0.2, N=N, samples=20)
	f = open("results/N-128-16-100.txt","a")
	f.write("%d" % (N))
